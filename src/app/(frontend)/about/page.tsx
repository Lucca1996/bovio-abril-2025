                ...
                <div className="max-w-screen-xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="relative">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="md:text-right md:pr-12 relative group mt-8 md:mt-0">
                                    <div className="absolute right-0 md:right-[-24px] top-0 w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center z-10 group-hover:scale-110 transition-transform">2023</div>
                                    <div className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
                                        <h3 className="text-xl font-bold mb-2 dark:text-white">Gran Cliente</h3>
                                        <p className="text-gray-700 dark:text-gray-300">Durante el 2023 el Hospital Padilla confio en nosotros para realizar trabajos que se pueden observar en la pagina.</p>
                                    </div>
                                </div>
                    ...
                    <div className="mb-20 py-16 bg-primary/5 dark:bg-primary/10 rounded-3xl">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                            ...
                            <div className="p-6">
                                <div className="text-4xl font-bold text-primary mb-2">Todo el pais</div>
                                <p className="text-gray-700 dark:text-gray-300">Nos comprometemos a llevar la solucion a donde se necesite.</p>
                            </div>
                        </div>
                    </div>
